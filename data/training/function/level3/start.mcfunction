...
tellraw @a[tag=en] [{"text":"Narrator: ","color":"gold"},{"text": "Speak with the trader","strikethrough":true, "color": "white"},{"text":" Open the chest to get bow and arrows.","color":"white"}]
tellraw @a[tag=ru] [{"text":"Рассказчик: ","color":"gold"},{"text": "Поговори с торговцем","strikethrough":true, "color": "white"},{"text":" Открой сундук, чтобы получить лук и стрелы.","color":"white"}]
